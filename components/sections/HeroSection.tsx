    ...
    >
      ...
      >
        ...
        >
          <Link
            href="/work"
            className="btn-cinema-filled text-sm py-4 px-10 inline-block"
          >
            View My Work
          </Link>
          <Link
            href="/contact"
            className="btn-cinema text-sm py-4 px-10 inline-block"
          >
            Let's Create
          </Link>
        </motion.div>
        ...
        >
          {[
            ...
            <div key={s.label} className="text-center">
              <div className="font-display text-2xl md:text-3xl text-cinema-gold">
                {s.val}
              </div>
              <div className="font-mono text-[9px] tracking-[3px] text-cinema-gray mt-1 uppercase">
                {s.label}
              </div>
            </div>
          ))}
      ...
      >
        <span className="font-mono text-[9px] tracking-[4px] text-cinema-gray uppercase">
          Scroll
        </span>
...
function ParticleField() {
  ...
  // Generate particles only once when component mounts on client

...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const waNumber = "918717818475"; // WhatsApp number with country code, no +
    ...
    <>
      ...
      <main>
        ...
        <section className="py-24 relative bg-cinema-black" ref={ref}>
          <div className="inset-0 grid-bg opacity-15" />
              ...
              >
                <div>
                  ...
                  <p className="font-body text-cinema-gray text-lg leading-relaxed">
                    Whether it's a wedding, corporate video, or creative project
                ...
                {[
                  ...
                  >
                    ...
                    <div>
                      <div className="font-mono text-[9px] tracking-[3px] text-cinema-gray uppercase mb-1">
                        {item.label}
                      </div>
                      <div className="font-body text-cinema-white group-hover:text-cinema-gold transition-colors duration-300 break-all">
                        {item.value}
                      </div>
                      <div className="font-mono text-[8px] text-cinema-gray mt-1 tracking-widest">
                        {item.sub}
                      </div>
                    </div>
                  </a>
                ...
                {submitted ? (
                  ...
                  >
                    <div>
                      ...
                      <h3 className="font-display text-3xl text-cinema-gold tracking-wider mb-4">
                        Opening WhatsApp!
                      </h3>
                      <p className="font-body text-cinema-gray text-lg italic">
                        Your project brief is ready to send. A WhatsApp window
                        has opened — just hit send to reach Virendra directly.
                      </p>
                      <button
                        onClick={() => {
                          setSubmitted(false);
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <p className="text-center font-mono text-[9px] tracking-[2px] text-cinema-gray uppercase">
